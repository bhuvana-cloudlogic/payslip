...
<h4 class="panel-title">Settings for Inclusion and Deduction</h4>
</div>
<div class="panel-body">
	
<div class="well">	
	<legend>settings for Inclusion and Deduction</legend>
	<br>
	<div class="row">
						   ...
						   <div class="form-group">
							   ...
							   <div class="col-md-7">
								  <select class="form-control selectpicker" name="field_name" id="field">
											 ...
											 <option value="Advance salary if paid">Advance salary if paid</option>
											 <option value="other Deduction">Other Dedcution</option>
								   </select>
