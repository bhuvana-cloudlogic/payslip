   <title>Generate Payslip</title> 
	...
	<div class="col-md-12">
		...
		<div class="col-md-12">
		    ...
		    <div class="col-md-3 form-group">
			<input type="text" class="form-control" name="emp_department" id="emp_department">
  		    </div>
		</div>
	    </div>
	    <p></p>
		...
		<div class="col-md-12">
		    ...
		    <div class="col-md-3 form-group">
			<input type="text" class="form-control" name="payslip_no" value="">
		    </div>
		    <div class="col-md-1">
		    ...
		    <div class="col-md-3">
				...
				<div class="input-group input-append date" id="datePicker2">
				    <input type="text" class="form-control" name="joindate" id="joindate" placeholder="" />
		...
		<div class="col-md-12">
		    ...
		    <div class="col-md-3 form-group">
			<input type="text" class="form-control" name="tworking_days" id="tworking_days" value="" />
		    </div>
		    <div class="col-md-1">
		...
		<div class="col-md-12">
		    ...
		    <div class="col-md-3">
			    <div class="form-group">
				<input type="text" class="form-control" name="account" id="account"  placeholder="Account No." />
			    </div>
			</div>
		    ...
		    <div class="col-md-3">
				...
				<div class="input-group input-append date" id="datePicker">
				    <input type="text" class="form-control" name="paydate" id="paydate" placeholder=" For the Month of" />
				    <span class="input-group-addon add-on"><span class="glyphicon glyphicon-calendar"></span></span>
				</div>
			</div>
		    </div>
    ...
    $('#defaultForm').bootstrapValidator({
	    ...
	    basic_salary:{
                ...
                regexp: {
                            message: 'The field can only contain the digits, spaces, -, (, ), + and .',
                            regexp: /^[0-9\s\-()+\.]+$/
                        }
                }
            },
