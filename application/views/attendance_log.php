						...
						<div class="well">
						    ...
						    <div id="idmonth">
                                                     <div class="col-sm-1">
                                                        ...
                                                        <div class="col-sm-5" >
                                                      <select id="selectpicker1"  name="month"  class="form-control selectpicker">
                                                    ...
                                                    <div class="input-group date" id='datetimepicker1'>
                                                      <input type='text' class="form-control" name="fromdate" value="" id="fromdate" />
                                                 ...
                                                 <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                      ...
                                                      <div class="col-sm-1" id="labelyear">
                                                        ...
                                                        <div class="col-sm-5" >
                                                        <select id="selectpicker2"  name="year" class="form-control selectpicker">
												...
												<div id="idyear1">
                                                      ...
                                                      <input type='text' id="todate" name="todate" class="form-control" value=""  />
                                                        <span class="input-group-addon">
                                                            <span class="glyphicon glyphicon-calendar"></span>
                                                        </span>
                                        ...
                                        <div class="row">
                                         ...
                                         <input type="submit" name="submit" value="Show Records" class="btn btn-info">
