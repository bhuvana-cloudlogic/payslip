...
$date->setTimezone($timezone );?>
			...
			<div class="col-md-3">
			    ...
			    <input placeholder="Work Hours" name="workHours" id="workHours"  value="<?php echo $result[0]['total_working_hours']; ?>"  class="form-control input-md total clearVal"   type="text">
	...
	$('#dailyDate').blur(function(){
		...
		success: function (json) {
			...
			$("#clChkBox").prop('checked', false); 
                //var mrngtime=$("#timepicker1").val('10:00AM');
		//var mendtime=$("#timepicker2").val('01:30PM');
		//var Evestartime=$("#timepicker3").val('02:30PM');
		//var Eveendtime=$("#timepicker4").val('08:00PM');
		    }
		    else{
