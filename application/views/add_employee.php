...
<div class="col-md-12">
	...
	<div class="col-md-6">
			...
			<div class="col-md-9">
				<input type="text" class="form-control" style="text-transform: capitalize;" name="emp_bank_name" placeholder="Bank name"  />
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<input type="text" style="text-transform: capitalize;" class="form-control" name="emp_ifsc_code" placeholder="IFSC Code"  />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<input type="text" class="form-control" style="text-transform: capitalize;" name="emp_branch_name" placeholder="Branch name"  />
			</div>
		</div>
