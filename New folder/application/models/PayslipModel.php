...
function master_update_percentage()
   ...
   function increment_update($id){
	...
	$data=array(
		...
		$sql="select * from shift_details where ((SFT_EMP_NAME='$name' ) OR ( SFT_STATUS='Second_Saturday' OR SFT_STATUS='Fourth_Saturday' OR SFT_STATUS='Sunday' OR  SFT_STATUS='Festival_Holidays')) AND SFT_MONTH='$month' AND SFT_YEAR='$year'";
	    ...
	    {
		$sql="select * from shift_details where ((SFT_EMP_NAME='$name' ) OR ( SFT_STATUS='Second_Saturday' OR SFT_STATUS='Fourth_Saturday' OR SFT_STATUS='Sunday' OR  SFT_STATUS='Festival_Holidays')) AND SFT_YEAR='$year'";
	    ...
	    if($clickevent=='DataRange')
	    {
		   ...
		   $sql="select * from shift_details where ((SFT_EMP_NAME='$name' ) OR ( SFT_STATUS='Second_Saturday' OR SFT_STATUS='Fourth_Saturday' OR SFT_STATUS='Sunday' OR  SFT_STATUS='Festival_Holidays')) AND SFT_DATE BETWEEN '$fromdate' AND '$todate'";
		   return $this->db->query($sql)->result_array();
    ...
    function total_hrs_daterange()
	{
	    ...
	    $fromdate=$this->input->post('fromdate');
	    $todate=$this->input->post('todate');
	    $sql = "SELECT ROUND(SUM(SFT_WORKING_HOUR),2) as checkvalue FROM shift_details where SFT_EMP_NAME='$name' AND SFT_DATE BETWEEN '$fromdate' AND '$todate'";
	    return $this->db->query($sql)->result_array();
	}
	function total_hrs_monthly()
	{
		...
		$month=$this->input->post('month');
		$year=$this->input->post('year');
		$sql = "SELECT ROUND(SUM(SFT_WORKING_HOUR),2) as checkvalue FROM shift_details where SFT_EMP_NAME='$name' AND SFT_MONTH='$month' AND SFT_YEAR='$year'";
		return $this->db->query($sql)->result_array();
	    }
		...
		$name=$this->input->post('empname');
	    $year=$this->input->post('year');
	    $sql = "SELECT ROUND(SUM(SFT_WORKING_HOUR),2) as checkvalue FROM shift_details where SFT_EMP_NAME='$name' AND SFT_YEAR='$year'";
	    return $this->db->query($sql)->result_array();
	    }
	...
	if($month)
	{
	    $sql="SELECT count(SFT_MONTH) as ssmonth from shift_details WHERE SFT_EMP_NAME='$name' AND SFT_MONTH='$month' and SFT_STATUS='present'";
	    return $this->db->query($sql)->result_array();
	}
	elseif($year)
	{
	   $sql="SELECT count(SFT_MONTH) as ssmonth from shift_details WHERE SFT_EMP_NAME='$name' AND SFT_YEAR='$year' and SFT_STATUS='present'"; 
	    return $this->db->query($sql)->result_array();	
	}
    }
   function present_status($name,$month)
	...
	$sql="SELECT count(SFT_MONTH) as ssmonth from shift_details WHERE SFT_EMP_NAME='$name' AND SFT_STATUS='Present' AND SFT_DATE BETWEEN '$fromdate' AND '$todate' ";
	return $this->db->query($sql)->result_array();
	...
	$todate=$this->input->post('todate');
	$fromdate=$this->input->post('fromdate');
$sql="SELECT SUM(SFT_VALUE) as ssmonth from shift_details WHERE SFT_EMP_NAME='$name' AND SFT_DATE BETWEEN '$fromdate' AND '$todate' and SFT_STATUS IN ('Half-Day','LOP')";
	...
	$todate=$this->input->post('todate');
	$fromdate=$this->input->post('fromdate');
	$sql="SELECT count(SFT_MONTH) as ssmonth from shift_details WHERE SFT_EMP_NAME='$name' AND SFT_DATE BETWEEN '$fromdate' AND '$todate' and SFT_STATUS='CL'";
	return $this->db->query($sql)->result_array();
    }
	...
	$todate=$this->input->post('todate');
	$fromdate=$this->input->post('fromdate');
	$sql="SELECT count(SFT_MONTH) as ssmonth from shift_details WHERE ( SFT_STATUS='Second_Saturday' OR SFT_STATUS='Fourth_Saturday' OR SFT_STATUS='Sunday' OR SFT_STATUS='Festival_Holidays') AND SFT_DATE BETWEEN '$fromdate' AND '$todate' ";
        return $this->db->query($sql)->result_array();
    }
	...
	if($month)
	{
	    $sql="SELECT count(SFT_MONTH) as ssmonth from shift_details WHERE ( SFT_STATUS='Second_Saturday' OR SFT_STATUS='Fourth_Saturday' OR SFT_STATUS='Sunday' OR SFT_STATUS='Festival_Holidays') AND SFT_MONTH='$month'";
	    return $this->db->query($sql)->result_array();
	}
	elseif($year)
	{
	    $sql="SELECT count(SFT_MONTH) as ssmonth from shift_details WHERE ( SFT_STATUS='Second_Saturday' OR SFT_STATUS='Fourth_Saturday' OR SFT_STATUS='Sunday' OR SFT_STATUS='Festival_Holidays') AND SFT_YEAR='$year' ";
	    return $this->db->query($sql)->result_array();
	}
	...
	if($month)
	{
	    $sql="SELECT SUM(SFT_VALUE) as ssmonth from shift_details WHERE SFT_EMP_NAME='$name' AND SFT_MONTH='$month'and SFT_STATUS IN('LOP','Half-Day')";
	    return $this->db->query($sql)->result_array();
	}
	elseif($year)
	{
	   $sql="SELECT SUM(SFT_VALUE) as ssmonth from shift_details WHERE SFT_EMP_NAME='$name' AND SFT_YEAR='$year' and SFT_STATUS IN('LOP','Half-Day')"; 
	    return $this->db->query($sql)->result_array();	
	}
    }
    function CL()
	...
	if($month)
	{
	    $sql="SELECT count(SFT_MONTH) as ssmonth from shift_details WHERE SFT_EMP_NAME='$name' AND SFT_MONTH='$month'and SFT_STATUS='CL'";
	    return $this->db->query($sql)->result_array();
	}
	elseif($year)
	{
	   $sql="SELECT count(SFT_MONTH) as ssmonth from shift_details WHERE SFT_EMP_NAME='$name' AND SFT_YEAR='$year' and SFT_STATUS='CL'"; 
	    return $this->db->query($sql)->result_array();	
	}
  ...
  function update_employee_list($id){
   ...
   function update_Shift_details($val){
	...
	$sql = "SELECT * FROM shift_details where SFT_EMP_NAME='$var'";
	return $this->db->query($sql, $return_object = TRUE)->result_array();
    }
