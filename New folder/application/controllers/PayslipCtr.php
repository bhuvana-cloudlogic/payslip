 ...
 }else if($this->input->post('pickername')=='test1') //dropdown list
 {
  ...
  $result['inc1']=$this->ps_model->getincrement_data($user,$month);
   ...
   function getHistory(){
	...
	$data['history']=$this->ps_model->getHistory($get);
