...
<div class="col-md-9">
<input type="text" class="form-control" style="text-transform: capitalize;" name="emp_bank_name" placeholder="Bank name" value="<?php echo $result[0]['EMP_BANK_NAME']; ?>"   />
</div>
</div>
<div class="form-group">
...
<div class="col-md-9">
<input type="text" class="form-control" name="emp_ifsc_code" placeholder="IFSC Code" value="<?php echo $result[0]['EMP_IFSC_CODE']; ?>"   />
</div>
</div>
...
<div class="col-md-9">
<input type="text" class="form-control" style="text-transform: capitalize;" name="emp_branch_name" placeholder="Branch name"  value="<?php echo $result[0]['EMP_BRANCH_NAME']; ?>" />
</div>
</div>
<div class="form-group">
